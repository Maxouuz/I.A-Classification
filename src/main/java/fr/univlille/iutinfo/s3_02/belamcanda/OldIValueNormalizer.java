...
//public interface OldIValueNormalizer {
	 ...
	 * <li>POKEMON_TYPE_NORMALIZER: Normalise une valeur parmis les types de Pokemon
	 * possible. Chaque type recoit une valeur unique entre 0 et 1</li>
	 * <li>etc. Chaque type enumere cree pour un DataSet doit avoir une constante
