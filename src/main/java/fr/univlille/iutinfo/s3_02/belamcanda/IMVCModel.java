...
public interface IMVCModel {
	...
	/**
	 * Charge les donnees du modele d'une String "CSV". Cette methode est surtout un
	 * utilitaire de test pour eviter d'avoir a creer des fichiers CSV pour tous les
	 * cas de test. Il suffit d'appeller cette methode avec une String contenant les
	 * lignes d'un "fichier CSV" que l'on veut tester.
	 */
